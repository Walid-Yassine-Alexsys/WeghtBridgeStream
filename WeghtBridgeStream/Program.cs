...
public sealed class WeightBridgeService : BackgroundService, IWeightBridge
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        // ==========================
        // REAL LIVE MODE — BYTE READER (like Vrac exe)
        // ==========================
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            try
            {
                ...
                while (!stoppingToken.IsCancellationRequested)
                {
                    ...
                    // ==========================
                    // STABILITY RULES (unchanged):
                    //   - value repeated many times
                    //   - AND >= 2000 kg
                    // ==========================
                    ...
                    // Always publish real-time when above a threshold
                    if (current > 2000m)
                    {
